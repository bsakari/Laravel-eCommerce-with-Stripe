<div id="billing-block" class="row{{ $fees['total'] == 0 ? ' hide' : '' }}">
    <div class="col-md-3">
    ...
    <div class="col-md-9">
        @if (auth()->check())
            @if (auth()->user()->billingAddresses()->count() > 0)
                <div class="row">
                    <div class="col-md-12">
                        <input type="hidden" name="billing[address_id]" value="{{ auth()->user()->billingAddress()->first()['id'] }}"{{ $fees['total'] == 0 ? ' disabled' : '' }} />
