<div id="payment-block" class="row{{ $fees['total'] == 0 ? ' hide' : '' }}">
    <div class="col-md-3">
    ...
    <div class="col-md-9">
        @if (auth()->check())
            @if (auth()->user()->cards()->count() > 0)
                ...
                <div id="current-card-block" class="row">
                    <div class="col-md-12">
                        <input type="hidden" name="card_id" value="{!! auth()->user()->primaryCard()->first()['id'] !!}"{{ $fees['total'] == 0 ? ' disabled' : '' }} />
            ...
            @else
                ...
                <label id="save-payment-method-block" class="pull-right" style="color: #666666; font-size: 14px; font-weight: normal;">
        ...
        @else
            ...
            <label id="save-payment-method-block" class="pull-right" style="color: #666666; font-size: 14px; font-weight: normal;">
                <input type="checkbox" name="save_payment_method" value="1"{{ old('save_payment_method') ? ' checked' : '' }} />
