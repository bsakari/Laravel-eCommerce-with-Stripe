                                        ...
                                        <table class="invoice">
                                            <tr>
                                                <td>
                                                    ...
                                                    Subtotal: ${!!  $fees['subtotal'] !!} USD<br />
                                                    Tax: ${!!  $fees['tax'] !!} USD<br />
                                                    Shipping: ${!!  $fees['shipping'] !!} USD<br />
                                                    Total: ${!!  $fees['total'] !!} USD<br />
                                                    <br /><br />
                                                ...
                                                <td>
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="alignright">${!!  $cartItem['price'] !!}</td>
                                                            <td class="alignright">${!!  $cartItem['price'] * $cartItem['count'] !!}</td>
                                                        </tr>
                                                        @endforeach
                                                    </table>
                                                    <br /><br />
