@component('layouts.admin')
    ...
    @slot('title')
        Admin - Edit Coupon - {{ config('app.name') }}
    @endslot
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form method="POST" action="{{ route('admin.coupons.update', $coupon['id']) }}" class="form-horizontal" accept-charset="UTF-8" role="form">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="code" class="form-control" name="code" value="{{ old('code', $coupon['code']) }}" maxlength="20" required />
                        ...
                        <div class="form-group{{ $errors->has('type') || $errors->has('discount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6{{ $coupon['type'] == 'amount' ? ' hide' : '' }}" id="discount-percentage-block">
                                <label for="discount-percentage" class="control-label required">Discount Percentage:</label>

                                <div class="input-group">
                                    <input type="number" id="discount-percentage" class="form-control" name="discount_percentage" value="{{ old('discount_percentage', $coupon['discount_percentage']) }}" max="100" maxlength="3" min="0" pattern="[0-9]{10}" step="1"{{ $coupon['type'] == 'amount' ? ' disabled' : '' }} required />
                            ...
                            <div class="col-md-6{{ $coupon['type'] == 'percentage' ? ' hide' : '' }}" id="discount-amount-block">
                                <label for="discount-amount" class="control-label required">Discount Amount:</label>

                                <div class="input-group">
                                    <div class="input-group-addon">$</div>

                                    <input type="number" id="discount-amount" class="form-control" name="discount_amount" value="{{ number_format(old('discount_amount', $coupon['discount_amount']), 2) }}" maxlength="6" min="0" step="0.01"{{ $coupon['type'] == 'percentage' ? ' disabled' : '' }} required />
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('shipping') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                ...
                                <input type="checkbox" id="shipping" name="shipping" value="1"{{ old('shipping', $coupon['shipping']) ? ' checked' : '' }} />
                        ...
                        <div class="form-group{{ $errors->has('limited') ? ' has-error' : '' }}">
                            <div class="col-md-12">
                                ...
                                <input type="checkbox" id="limited" name="limited" value="1"{{ old('limited', $coupon['limited']) ? ' checked' : '' }} />
                        ...
                        <div class="form-group hide{{ $errors->has('limit') ? ' has-error' : '' }}" id="limit-block">
                            <div class="col-md-6">
                                ...
                                <input type="number" id="limit" class="form-control" name="limit" value="{{ old('limit', $coupon['limit']) }}" maxlength="10" disabled required />
                        ...
                        <div class="form-group{{ $errors->has('start') ? ' has-error' : '' }}">
                            <div class="col-md-6">
                                ...
                                <div class="input-group date">
                                    <input type="text" id="start" class="form-control" name="start" value="{{ old('start', !empty($coupon['start']) ? $coupon['start']->timezone(config('custom.timezone'))->format('m/d/Y g:i A') : null) }}" />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group date">
                                    <input type="text" id="end" class="form-control" name="end" value="{{ old('end', !empty($coupon['end']) ? $coupon['end']->timezone(config('custom.timezone'))->format('m/d/Y g:i A') : null) }}" />
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-success pull-right" title="Update this new coupon"><i class="fa fa-save"></i> Save</button>
                            </div>
                        </div>
                    </div>
                </div>
