...
class OptionsController extends Controller {
    ...
    public function store(Request $request, $attribute)
    {
        ...
        if ($createdOption) {
            ...
            return redirect(route('admin.attributes.show', $attribute['id']))->with('alert-success', 'The option has been added successfully.');
        } else {
    ...
    public function update(Request $request, $attribute, $option)
    {
        ...
        return redirect(route('admin.attributes.show', $attribute['id']))->with('alert-success', 'The option has been updated successfully.');
    }
    ...
    public function destroy($attribute, $option)
    {
        if ($option->inventoryItems() && $option->inventoryItems()->count() > 0) {
            ...
            return redirect(route('admin.attributes.show', $attribute['id']))->with('alert-success', 'The option has been removed successfully.');
        }
    }
