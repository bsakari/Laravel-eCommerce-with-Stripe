...
class ProductsController extends Controller {
    ...
    public function store(Request $request)
    {
        ...
        if ($createdProduct) {
            ...
            if ($request->hasFile('photos')) {
                if (env('SHOP_DEMO')) {
                    return redirect(route('admin.products.show', $createdProduct['id']))->with('alert-success', 'The product has been added successfully, but photo upload is not available in this demo mode.');
                }
            ...
            return redirect(route('admin.products.show', $createdProduct['id']))->with('alert-success', 'The product has been added successfully.');
        } else {
    ...
    public function update(Request $request, $product) {
        ...
        if ($request->hasFile('photos')) {
            if (env('SHOP_DEMO')) {
                ...
                return redirect(route('admin.products.show', $product['id']))->with('alert-success', 'The product has been updated successfully, but photo upload is not available in this demo mode.');
            }
        ...
        return redirect(route('admin.products.show', $product['id']))->with('alert-success', 'The product has been updated successfully.');
    }
    ...
    {
        // The Product must not have any associated Inventory Items to be deleted
        ...
        // The Product must not have any associated Photos to be deleted
        elseif ($product->photos() && $product->photos()->count() > 0) {
            ...
            return redirect(route('admin.products.index'))->with('alert-success', 'The product has been removed successfully.');
        }
    }
